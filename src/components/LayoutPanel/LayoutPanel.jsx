...
export default function LayoutPanel() {
  const [activeTab, setActiveTab] = useState("layout"); // 단일탭
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "0px" }}>
        <Category label="평면 (Floor Plan)" />
        <Category label="천장 평면도 (Ceiling Plan)" />
        <Category label="3D 뷰 (3D View)" />
        <Category label="입면도 (Elevation)" />
      </div>
    </div>
  );
}
